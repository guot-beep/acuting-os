<!-- Extracted from curriculum/herbs/Materia Medica III – Astringent Herbs (Stabilize&Bind).pdf by scripts/extract-curriculum-md.js.
     Text layer only — figures, tables-as-images and formatting are NOT here.
     Cite as curriculum/herbs/Materia Medica III – Astringent Herbs (Stabilize&Bind).pdf#p<N> and verify against the original before
...
Wu Mei       Neutral              LU, SP, LV, LI                  Stops cough;
He Zi        Neutral              LU, LI                          generates fluids;
Chi Shi Zhi  Warm                 SP, ST, LI                      stabilizes essence;
                                                                  calms Shen
...
Herb            Nature            Channels         Core Exam
Rou Dou Kou     Warm              SP, ST, LI       Keywords
                                                   Warms Middle Jiao;
Chun Gen Pi     Cold              LI, ST, LV       stops diarrhea;
                                                   moves qi
Qian Shi        Neutral           SP, KD           Clears damp-heat;
Lian Zi         Neutral           HT, SP, KD       binds Intestines;
Lian Xu         Neutral           HT, KD, SP       stops bleeding
Shan Zhu Yu     Slightly warm     LV, KD           Tonifies SP;
Jin Ying Zi     Neutral           KD, LI           stabilizes essence
Sang Piao Xiao  Neutral           KD               Tonifies SP & KD;
Fu Pen Zi       Warm              KD, LV           calms Shen
Hai Piao Xiao   Warm              KD, ST           Tonifies SP, stops
Fu Xiao Mai     Cool              HT               diarrhea
Ma Huang Gen    Neutral           LU
Lian Zi Xin     Cold              Bitter           Stabilizes KD;
                                                   tonifies yin
                                                   Binds Intestines;
                                                   treats prolapse
                                                   Tonifies KD yang;
