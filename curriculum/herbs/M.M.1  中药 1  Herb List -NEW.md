<!-- Extracted from curriculum/herbs/M.M.1  中药 1  Herb List -NEW.pdf by scripts/extract-curriculum-md.js.
     Text layer only — figures, tables-as-images and formatting are NOT here.
     Cite as curriculum/herbs/M.M.1  中药 1  Herb List -NEW.pdf#p<N> and verify against the original before
     using any number (dose, depth, lab value) from it. -->

## p.1

Dr. Erin Stewart                                                                               Bastyr University
