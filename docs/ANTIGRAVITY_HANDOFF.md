...
## ⏳ Task 9A：中藥 + 方劑 來源傳輸完整性審計（待驗收）

- **類型**: READ-ONLY Canonical Provenance & Transport Integrity Audit（正典與生成檔 0 異動）
- **分支**: antigravity/task9a-source-integrity-audit
...
- **摘要數據**:
  - 唯一 HTTP URL 探測: 1,266 條（OK_200: 1,086, REDIRECT_TO_200: 3, DEAD_4XX: 96, SERVER_5XX: 76, TIMEOUT: 3）
  - 本地路徑引用: 5,733 處（LOCAL_EXISTS: 2,890, LOCAL_MISSING: 2,843）
  - Malformed URL: 0 處
