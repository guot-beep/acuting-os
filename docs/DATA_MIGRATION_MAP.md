...
| Acupoint anatomy and high-risk safety staging | `data/imports/acupoint_anatomy/*.json` | `scripts/preview-acupoint-anatomy-review.js`, `scripts/preview-acupoint-anatomy-fill.js`; NOT wired into app | Peer-reviewed ultrasound/MRI/cadaver/anatomy literature | REVIEW-ONLY; 44 high-risk ultrasound points, 66 unique review points, 34 fill-empty field proposals / 38 values; no apply mode, canonical `361.json` unchanged |
