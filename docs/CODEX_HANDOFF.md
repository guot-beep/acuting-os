...
## [2026-08-20] Codex Handoff — TDIS／herb contraindications／formula songs and rulings

- **Branch / Base / Commits**: `codex/tdis-herb-fill-20260820`, based on `origin/claude/system-optimization-3ptpk0` at `091af577`; local commits `f7d3c576`, `cdbe961a`, `08fcb123`, `23cfed20`, `bf395bd4`, `dd8752b3`. Nothing was pushed and no PR was opened.
- **Scope / Files**: source changes are limited to `data/herbs/formulas.json`, `data/herbs/herb_canon_shortlist.json`, and `data/pathology/tdis_registry.json`; generated `data/generated/knowledge_data.js` and `data/audits/formula_no_loss_snapshot.json` were rebuilt/updated. The upstream condition-card commits `5c67d5a6` and `091af577` are preserved and were not edited here.
