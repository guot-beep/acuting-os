...
| **DEPRECATED_BUT_REFERENCED Records** | 0 | 1 | 1 |
...
| `DEPRECATED_BUT_REFERENCED` | **HIGH** | `formula.bai_du_san` | formula | Deprecated record formula.bai_du_san is referenced by 4 active records/fields. |
...
| Record ID | Chinese Name | English Name | Status | Incoming Refs | Risk | Reason |
|---|---|---|---|---|---|---|
| `formula.bai_du_san` | 敗毒散 | Overcome Pathogenic Influences Powder | `deprecated` | 4 | `DEPRECATED_BUT_REFERENCED` | Marked deprecated in canonical record |
