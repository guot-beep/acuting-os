...
| 方劑卡 Public EN「現代對應病名」印中文 chip 的卡 | 97 | 0(渲染器 en‖zh + 219 名字典 → 97 方 1,301 項) |
| 方劑 symptoms_en 缺 | 7 方 | 0 |
...
- 病名資料裡 8 個含 CJK 相容字(U+F98A 力、U+F962 異;重症肌無力 ×1、子宮內膜異位症 ×6 等 7 方)與 3 個疑錯字(尿道膿傷→膿瘍、女性乳房腫廇→腫瘤、癲狂狂躁)zh 未動,英譯照原意;要不要正規化/改字待 Ting。
