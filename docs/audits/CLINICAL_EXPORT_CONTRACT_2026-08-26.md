...
- **Base SHA (origin/main)**: `bcb8b7ae07bfd306c8e3e71c092dc7b48647ee6e`
- **Audit Source SHA**: `0e0eb7aefc3962e79a3dc7af1c74975dc96ee3bc`
...
| **Mutation-Boundary Fixtures** | **15** | 15 組直通實體 `app.js::importClinicalCases` 與 `restoreV2Envelope` 之隔離測試 |
...
| **Partial-Input Overwrite Protection** | **VERIFIED** | 實體執行證實：R12(2026-08-27)修復後，Merge 模式改為逐欄位合併，同 ID 部分欄位物件不再重置既有欄位（見下方 Q8） |
