# Evidence & Provenance Fragmentation Inventory — Task 10D (Round 4)

- **Audit Date**: 2026-08-27
- **Base SHA (origin/main)**: `297a8e2dd9159334b0ebfb26935c1450551fc209`
- **Audit Source SHA**: `297a8e2dd9159334b0ebfb26935c1450551fc209`
...
|---|---|---|
| `source_hint` | `SURVIVES_VERBATIM` | formulas: 100% value equality verified across 116/116 sampled records |
| `review_status` | `SURVIVES_VERBATIM` | avs_advice_library: 100% value equality verified across 13/13 sampled records |
| `source_status` | `SURVIVES_VERBATIM` | acupoints_361: 100% value equality verified across 126/126 sampled records |
| `source_urls` | `SURVIVES_VERBATIM` | comparisons: 100% value equality verified across 9/9 sampled records |
| `exact_source_url` | `SURVIVES_VERBATIM` | formulas: 100% value equality verified across 217/217 sampled records |
| `source_type` | `SURVIVES_VERBATIM` | comparisons: 100% value equality verified across 9/9 sampled records |
| `safety_source_url` | `SURVIVES_VERBATIM` | formulas: 100% value equality verified across 83/83 sampled records |
| `safety_source` | `SURVIVES_VERBATIM` | formulas: 100% value equality verified across 140/140 sampled records |
| `cloudtcm_url` | `SURVIVES_VERBATIM` | acupoints_361: 100% value equality verified across 361/361 sampled records |
| `american_dragon_url` | `SURVIVES_VERBATIM` | formulas: 100% value equality verified across 188/188 sampled records |
| `source_citations` | `SURVIVES_VERBATIM` | herbs: 100% value equality verified across 164/164 sampled records |
| `field_sources` | `SURVIVES_VERBATIM` | pharm_drug_classes: 100% value equality verified across 48/48 sampled records |
| `card_grade` | `SURVIVES_VERBATIM` | herbs: 100% value equality verified across 356/356 sampled records |
| `original_shape` | `NOT_BUNDLED` | Dataset not in runtime build path |
| `source_field` | `NOT_BUNDLED` | Dataset not in runtime build path |
| `import_artifacts` | `SURVIVES_VERBATIM` | condition_canon: 100% value equality verified across 130/130 sampled records |
| `authored_by` | `SURVIVES_VERBATIM` | pharm_drug_classes: 100% value equality verified across 6/6 sampled records |
| `safety_review` | `SURVIVES_VERBATIM` | herbs: 100% value equality verified across 1/1 sampled records |
| `classic_formula_source_zh` | `SURVIVES_VERBATIM` | herbs: 100% value equality verified across 1/1 sampled records |
| `classic_formula_source_en` | `SURVIVES_VERBATIM` | herbs: 100% value equality verified across 1/1 sampled records |
| `herb_pair_source_note_zh` | `SURVIVES_VERBATIM` | herbs: 100% value equality verified across 1/1 sampled records |
| `herb_pair_source_note_en` | `SURVIVES_VERBATIM` | herbs: 100% value equality verified across 1/1 sampled records |
| `last_reviewed` | `SURVIVES_VERBATIM` | comparisons: 100% value equality verified across 9/9 sampled records |
| `reference` | `NOT_BUNDLED` | Dataset not in runtime build path |
| `source_classic` | `SURVIVES_VERBATIM` | formulas: 100% value equality verified across 218/218 sampled records |
| `reviewed_by` | `NOT_BUNDLED` | Dataset not in runtime build path |
| `herb_drug_interaction_sources` | `SURVIVES_VERBATIM` | formulas: 100% value equality verified across 1/1 sampled records |
| `hierarchy_source_zh` | `SURVIVES_VERBATIM` | formulas: 100% value equality verified across 1/1 sampled records |
| `sources` | `SURVIVES_VERBATIM` | supplements: 100% value equality verified across 36/36 sampled records |
| `evidence` | `SURVIVES_VERBATIM` | red_flag_registry: 100% value equality verified across 186/186 sampled records |
| `source` | `SURVIVES_VERBATIM` | outcome_metrics: 100% value equality verified across 10/10 sampled records |
| `content_source` | `SURVIVES_VERBATIM` | condition_canon: 100% value equality verified across 130/130 sampled records |
| `acupoint_protocol_evidence` | `SURVIVES_VERBATIM` | condition_canon: 100% value equality verified across 133/133 sampled records |
| `protocol_status` | `NOT_BUNDLED` | Dataset not in runtime build path |
| `source_url` | `SURVIVES_VERBATIM` | cloudtcm_diseases: 100% value equality verified across 190/190 sampled records |
| `origin` | `SURVIVES_VERBATIM` | red_flag_registry: 100% value equality verified across 191/191 sampled records |
| `dailymed_setid` | `SURVIVES_VERBATIM` | pharm_drugs: 100% value equality verified across 59/59 sampled records |
| `dailymed_url` | `SURVIVES_VERBATIM` | pharm_drugs: 100% value equality verified across 59/59 sampled records |
| `verification_status` | `SURVIVES_VERBATIM` | pharm_drugs: 100% value equality verified across 34/34 sampled records |
| `dose_source` | `SURVIVES_VERBATIM` | supplements: 100% value equality verified across 34/34 sampled records |
