...
- **Base SHA (origin/main)**: `3ced3b32d029ed98f54c8e58a9995e18e186afc8`
...
|---|---|---|---|---|---|
| `review_status` | `REVIEW_STATE` | 3566 | 3566 | 20 | `string` |
| `field_sources` | `SOURCE_CITATION` | 2007 | 1991 | 10 | `object` |
| `evidence` | `EVIDENCE_STRENGTH` | 1521 | 1478 | 5 | `array, string` |
| `sources` | `SOURCE_CITATION` | 1468 | 1326 | 11 | `array` |
| `source_type` | `PROVENANCE` | 1404 | 1404 | 9 | `string` |
| `authored_by` | `AUTHORSHIP` | 1157 | 1156 | 11 | `string` |
...
| `red_flag_registry` | **233** | 0 (0%) | 0 (0%) | 233 (100%) | 233 (100%) | 0 (0%) | 0 (0%) | **0** (0%) |
...
| `evidence` | `evidence` | `red_flag_registry` | `SURVIVES_VERBATIM` | 193 | 100% value equality verified across 193/193 sampled records |
| `review_status` | `review_status` | `red_flag_registry` | `SURVIVES_VERBATIM` | 233 | 100% value equality verified across 233/233 sampled records |
| `authored_by` | `authored_by` | `red_flag_registry` | `SURVIVES_VERBATIM` | 233 | 100% value equality verified across 233/233 sampled records |
