...
| **OK_200 (Direct 200)** | 619 | 468 | 1084 |
| **REDIRECT_TO_200 (Followed Redirect to 200)** | 3 | 0 | 3 |
| **DEAD_4XX (HTTP 4xx Client Error)** | 89 | 6 | 95 |
...
| **Local Source Paths Checked** | 2760 | 3421 | 6181 |
| **LOCAL_EXISTS** | 2740 | 2733 | 5473 |
| **LOCAL_MISSING** | 20 | 688 | 708 |
...
### A. Dead Links (`DEAD_4XX`) -- 492 references
...
| `herb.fu_shen` | herb | `source_citations[3].url` | 403 | https://www.ncbahm.org/ |
...
### B. Missing Local Files (`LOCAL_MISSING`) -- 708 references
...
| `herb.zhu_ye` | herb | `source_citations[1].url` | `-NEW.md` | `curriculum/herbs/M.M.1  中药 1  Herb List -NEW.md` |
| `herb.zhu_ye` | herb | `field_sources.identity[0]` | `-NEW.md` | `curriculum/herbs/M.M.1  中药 1  Herb List -NEW.md` |
| `herb.zhu_ye` | herb | `field_sources.category[0]` | `-NEW.md` | `curriculum/herbs/M.M.1  中药 1  Herb List -NEW.md` |
| `herb.zhu_ye` | herb | `field_sources.cautions_zh[1]` | `-NEW.md` | `curriculum/herbs/M.M.1  中药 1  Herb List -NEW.md` |
