...
- **數字統計**:
  ...
  - CI 納管真實現況：CI_INVOKED 55 支、TRANSITIVE_CI 8 支、ORPHAN_BLOCKING_VALIDATOR 13 支、INFORMATIONAL_CI_STEP 5 支、MANUAL_ONLY 287 支、RED validators 4 支。
  - 四大專項問題：A (34 條 Active->Deprecated 引用)=GUARD_NOT_FOUND；B (D16 3 個退役 Pattern)=GUARD_NOT_FOUND；C (D11 舊命名空間)=GUARD_SCOPE_PARTIAL；D (退役 Herb/Formula ID)=GUARD_NOT_FOUND。
