...
const xql = {
  ...
  "modifications_zh": [
    ...
    "水腫、小便不利者：加茯苓 15g、澤瀉 9g 利水滲濕"
  ],
  "modifications_en": [
    "Fluid retention with heat and restlessness: Add Shi Gao 15g (forms Xiao Qing Long Jia Shi Gao Tang)",
  ...
  "modifications": [
    {
      ...
      "change_zh": "加石膏 15g ➔ 即小青龍加石膏湯（清熱除煩）",
      "change_en": "Add Shi Gao 15g (forms Xiao Qing Long Jia Shi Gao Tang)"
    },
    {
      "if_zh": "喉中水雞聲、氣喘甚者",
      "if_en": "With severe wheezing and throat stridor",
      "change_zh": "加射干 9g、冬花 9g、紫菀 9g 降氣平喘",
      "change_en": "Add She Gan 9g, Kuan Dong Hua 9g, Zi Wan 9g"
    },
    {
      "if_zh": "水腫、小便不利者",
      "if_en": "With edema and dysuria",
      "change_zh": "加茯苓 15g、澤瀉 9g 利水滲濕",
  ...
  "formula_song_zh": "小青龍湯細辛麻，桂芍乾薑半夏加。\n五味甘草同煎服，外寒內飲喘咳差。",
