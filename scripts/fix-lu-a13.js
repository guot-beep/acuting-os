/**
 * fix-lu-a13.js
 * Cleans remaining A13 disease category tags for LU channel points.
 */
...
db.forEach(point => {
  if (!/^LU([1-9]|1[0-1])$/.test(point.code)) return;
...
console.log('✅ Cleaned remaining A13 tags for LU channel.');
