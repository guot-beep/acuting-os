/**
 * fix-gb-a13.js
 * Cleans remaining A13 disease category tags for GB channel points.
 */
...
db.forEach(point => {
  if (!/^GB([1-9]|[1-3][0-9]|4[0-4])$/.test(point.code)) return;
...
console.log('✅ Cleaned remaining A13 tags for GB channel.');
