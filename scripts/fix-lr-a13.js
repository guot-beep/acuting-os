/**
 * fix-lr-a13.js
 * Cleans remaining A13 disease category tags for LR channel points.
 */
...
db.forEach(point => {
  if (!/^LR([1-9]|1[0-4])$/.test(point.code)) return;
...
console.log('✅ Cleaned remaining A13 tags for LR channel.');
