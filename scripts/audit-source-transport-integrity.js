 ...
 *
 * READ-ONLY canonical provenance & transport audit for Herbs and Formulas (Task 9A Round 3).
...
const USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 AcuTing-Source-Integrity-Audit/3.0';
...
function tokenizeProvenance(text) {
  ...
  // C. Local Repository Path Tokenizer (Round 3 Enhanced)
  // Supports spaces, Unicode punctuation (–), Chinese characters, anchors (#p2, #L102, #L282-L312), and trailing annotations.
  // Starts with known repo prefixes: (curriculum|docs|data|scripts)/ and matches until valid file extension.
  const pathRegex = /(?:curriculum|docs|data|scripts)\/(?:(?!\.(?:pdf|md|json|html|txt|csv|js|tsv|png|jpg|jpeg|xlsx))[^\r\n;,.\uff0c\u3001\u3002\uff1b\uff1a\(\)\uff08\uff09"'])+?\.(?:pdf|md|json|html|txt|csv|js|tsv|png|jpg|jpeg|xlsx)(?:#[a-zA-Z0-9_\-\.]+)?/gi;
  let pmatch;
...
function runRegressionTests() {
  const fixtures = [
    ...
    // Real Failure Cases from User Feedback (Blocker 1)
    { name: 'real case: spaces in filename with anchor #L102', input: 'curriculum/herbs/MATERIA MEDICA AND SPECIAL PREP.md#L102', expectedUrl: null, expectedPath: 'curriculum/herbs/MATERIA MEDICA AND SPECIAL PREP.md' },
    { name: 'real case: spaces and hyphen in filename with anchor #p2', input: 'curriculum/herbs/MM2_Module 4_Warm_Interior_Herbs-1.pdf#p2', expectedUrl: null, expectedPath: 'curriculum/herbs/MM2_Module 4_Warm_Interior_Herbs-1.pdf' },
    { name: 'real case: Unicode en-dash and line range #L282-L312', input: 'curriculum/herbs/Materia Medica III \u2013 Qi-tonifying Herbs.md#L282-L312', expectedUrl: null, expectedPath: 'curriculum/herbs/Materia Medica III \u2013 Qi-tonifying Herbs.md' },
    { name: 'real case: path followed by Chinese annotation', input: 'curriculum/herbs/MATERIA MEDICA AND SPECIAL PREP.md#L102\uff08\u4e2d\u6587\u8aaa\u660e\uff09', expectedUrl: null, expectedPath: 'curriculum/herbs/MATERIA MEDICA AND SPECIAL PREP.md' },
    { name: 'real case: Chinese characters in filename', input: 'curriculum/herbs/\u81fa\u7063\u4e2d\u85e5\u5178\u7b2c\u56db\u7248\u82f1\u6587\u7248.pdf#p10', expectedUrl: null, expectedPath: 'curriculum/herbs/\u81fa\u7063\u4e2d\u85e5\u5178\u7b2c\u56db\u7248\u82f1\u6587\u7248.pdf' }
  ];
...
async function main() {
  ...
  const fullAuditJson = {
    ...
    audit_round: 'Round 3',
    audit_name: 'Herb + Formula Provenance Transport Integrity Audit (Task 9A Round 3)',
    summary: {
      herbs: herbStats,
  ...
  const mdContent = [
    '# Source Transport Integrity Audit (Task 9A Round 3)',
    '',
