/**
 * fix-ki-a13.js
 * Cleans remaining A13 disease category tags for KI channel points in both Chinese and English.
 */
...
db.forEach(point => {
  if (!/^KI([1-9]|1[0-9]|2[0-7])$/.test(point.code)) return;
...
console.log('✅ Cleaned remaining A13 tags (ZH & EN) for KI channel.');
