/**
 * fix-sp-a13.js
 * Cleans remaining A13 disease category tags for SP channel points.
 */
...
db.forEach(point => {
  if (!/^SP([1-9]|1[0-9]|2[0-1])$/.test(point.code)) return;
...
console.log('✅ Cleaned remaining A13 tags for SP channel.');
